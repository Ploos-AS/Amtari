...
BUILD := build
COMMON_SRC := src/amtari.c src/guest.c src/trap.c src/gemdos_m214.c src/fs.c src/prg.c src/exec_m215.c
...
check: $(TEST_M0) $(TEST_M1) $(TEST_M2) $(TEST_M2_FS) $(TEST_M2_PRG) $(TEST_M2_EXEC) $(TEST_M2_E2E) $(TEST_M2_COND) $(TEST_M2_ARITH) $(TEST_M2_ADDR) $(TEST_M2_COMPILER)
	...
	./$(TEST_M2_ADDR)
	./$(TEST_M2_COMPILER)
	@echo "M2.15 host regression checks: PASS"
...
cross-check: $(CROSS_PRG) $(STRESS_PRG) $(M213_PRG) $(M213_INDEX_PRG) $(M214_PRG) $(M215_PRG) $(TEST_M2_CROSS)
	...
	@echo "M2.15 PC-relative data EA + linked TOS relocation execution: PASS"
